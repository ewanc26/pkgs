...
| [`malachite`](./packages/malachite) | Last.fm/Spotify → ATProto scrobble importer (CLI) |
| [`malachite-web`](./packages/malachite-web) | Last.fm/Spotify → ATProto scrobble importer (web frontend, private) |
