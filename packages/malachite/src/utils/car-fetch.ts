/**
 * CAR export fetcher for ATProto repos.
 *
...
/**
 * Extract the PDS base URL from an @atproto/api AtpAgent.
 */
export function getPdsUrlFromAgent(agent: unknown): string {
  ...
  throw new Error('Cannot determine PDS URL from agent — pass --pds <url> explicitly');
}
